 ...
 // console.log(owner);
  ...
  it('Registration of fifth and subsequent airlines requires multi-party consensus of 50% of registered airlines',async()=>{
   ...
   it('check insurance buyer transaction',async()=>{
        ...
        const balancePreTransaction =  await web3.eth.getBalance(accounts[0]);
        const balancePreTransaction1 = await web3.eth.getBalance(accounts[6]);
        console.log(balancePreTransaction,balancePreTransaction1);
        await config.flightSuretyData.buy(accounts[0],accounts[6],{from:accounts[6],value:insuranceAmount});
        const balancePreTransaction3 =  await web3.eth.getBalance(accounts[0]);
        const balancePreTransaction4 = await web3.eth.getBalance(accounts[6]);
   ...
   it('buyFlight at real price',async()=>{
     try{
      await config.flightSuretyApp.buyFlight("Barkudapalko",accounts[0],accounts[8],{from:accounts[8],value:1000000000000000000});
     }
